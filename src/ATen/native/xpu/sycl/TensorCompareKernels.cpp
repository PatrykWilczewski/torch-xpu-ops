...
// Fused self-gradient of clamp.Tensor: one pass instead of the 11 elementwise
// ops the composite formula issues. NaN operands make every comparison false,
// which reproduces the composite's pass-through of grad.
template <typename scalar_t>
